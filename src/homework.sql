...
select * from cars where brand in
                         ('Toyota', 'Kia', 'Ford', 'Audi');
select * from cars where model like 'T%';
select * from cars where model like '%e';
select * from cars where  length(brand) = 5;
SELECT SUM(price) as total_sum from cars where brand = 'Mercedes-Benz';
...
select count(*) as count_0f_cars  from cars;
